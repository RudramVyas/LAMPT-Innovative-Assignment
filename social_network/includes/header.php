...
// $location = $_SERVER['DOCUMENT_ROOT'].'/social_network/functions/functions.php';
// echo $location;
// echo $_SERVER['DOCUMENT_ROOT'].'/social_network/functions/functions.php';
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav">
			...
			<li><a href="game.php?u_id=new">Game</a></li>
