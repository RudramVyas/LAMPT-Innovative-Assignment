...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		values('$first_name','$last_name','$username','Hello There. Im using NetLink!','...','$pass','$email','$country','$gender','$birthday','default_user.png','default_cover.jpg',NOW(),'$status','$posts','Noonegonnaguessit12312314323215345345fsdvgsdb')";
