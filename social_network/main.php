...
<html>
<head>
	<title>NetLink login and signup</title>
	<meta charset="utf-8">
...
<body>
	<div class="row">
		<div class="col-sm-12">
			<div class="well">
				<center><h1 style="color: white;">NetLink</h1></center>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-6" style="left:1%;">
			<img src="images/netlink.jpg" class="img-rounded" title="NetLink" width="650px" height="565px">
		...
		<div class="col-sm-6" style="left:8%:">
			<img src="images/netlinklogo.jpg" class="img-rounded" title="NetLink" width="80px" height="80px">
			<h2><strong>See what's happening in <br> the world right now</strong></h2><br><br>
			<h4><strong>Join NetLink Today.</strong></h4>
