...
<div class="row">
   <div class="col-sm-12">
        <div class="well">
            <center><h1 style="color: white;"><strong>Netlink</strong></h1></center>
        </div>
   </div>
</div>
<div class="row">
            ...
            <div class="l_pass">
                <form action="" method="post">
                    <div class="input-group">
                        <span class="inpuy-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    ...
                    <div class="input-group">
                    <span class="inpuy-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                    <input id="msg" type="text" class="form-control" placeholder="Someone" name="recovery_account" required>
                    </div><br>
                    <a style="text-decoration: none;foat: right;color: #187FAB;" data-toggle="tooltip" title="Signin" href="signin.php"> Back to Signin?</a><br><br>
